...
BARE_BLOCK_KUSTOMIZATION_RELEASE_PATH=${BARE_BLOCK_DEPLOY_PATH}/overlays/release
BARE_BLOCK_KUSTOMIZATION_TEST_PATH=${BARE_BLOCK_DEPLOY_PATH}/overlays/test
BARE_BLOCK_KUSTOMIZATION_FILE=${BARE_BLOCK_KUSTOMIZATION_RELEASE_PATH}/kustomization.yaml
