...
EBS_DISK_KUSTOMIZATION_TEST_PATH=${EBS_DISK_KUSTOMIZATION_RELEASE_PATH}/overlays/test
EBS_DISK_KUSTOMIZATION_FILE=${EBS_DISK_KUSTOMIZATION_TEST_PATH}/kustomization.yaml
